...
/** Convert a Hex encoded string to a Utf-8 encoded string. */ export declare function toText(hex: string): string;
/** Convert a Utf-8 encoded string to a Hex encoded string. */ export declare function fromText(text: string): string;
