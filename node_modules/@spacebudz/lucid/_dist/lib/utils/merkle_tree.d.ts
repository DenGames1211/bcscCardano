...
export declare class MerkleTree {
  private root: any;
  /** Construct Merkle tree from data, which get hashed with sha256 */ constructor(data: Uint8Array[]);
  /** Construct Merkle tree from sha256 hashes */ static fromHashes(hashes: Hash[]): MerkleTree;
  private build: any;
  rootHash(): Hash;
