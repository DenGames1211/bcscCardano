...
import { concat, equals } from "@jsr/std__bytes";
import { crypto } from "@jsr/std__crypto";
import { toHex } from "./utils.js";
export class MerkleTree {
  root;
  /** Construct Merkle tree from data, which get hashed with sha256 */ constructor(data){
    this.root = this.build(data.map(sha256));
  }
  /** Construct Merkle tree from sha256 hashes */ static fromHashes(hashes) {
